...
const ServiceSummary = ({navigation}) => {
  ...
  const hasNullTiming =
    !(isServiceItem && cartData?.items?.some(item => item?.timing === null));
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: Colors.white}}>
        ...
        <ScrollView
                      ...
                      <Text
                        ...
                        {item?.timing
                          ? convertTo12HourFormat(
                              String(item?.timing).substring(0, 5),
                            )
                          : 'Select Slot'}
                      </Text>
                    </View>
          ...
          <View
            style={{
              ...
              shadowColor:
                Platform.OS == 'ios' ? 'rgba(0,0,0,0.2)' : Colors.black,
              shadowOffset: {
                height: 0,
                width: 0,
              },
      ...
      <View
        ...
        {isServiceItem ? (
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                (!isCartEmpty && !hasNullTiming) ? Colors.deactive : Colors.black,
              height: normalize(42),
              justifyContent: 'center',
              marginHorizontal: normalize(15),
              alignItems: 'center',
      ...
      <Picker
        ...
        setIsVisible={() =>
          setSlotSelectionDetail({slotModal: false, selectedServiceId: ''})
        }
      />
    </SafeAreaView>
  );
